...
export function normalizeConfig(
  ...
  return {
    ...
    atmospheric_absorption: raw.atmospheric_absorption ?? d.atmospheric_absorption,
    absorption_db_per_km: raw.absorption_db_per_km ?? d.absorption_db_per_km,
