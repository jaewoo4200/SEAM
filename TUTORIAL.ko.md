...
![Visual 모드: 씬 트리, 디바이스/액터, 모드 탭 5개가 있는 툴바](docs/images/01_visual_mode.png)
*Sample Demo 프로젝트의 Visual 모드 — 왼쪽에 씬 트리와 DEVICES/ACTORS, 툴바에 모드 탭과 상태 칩이 보입니다.*
...
![경로 시뮬레이션 결과와 Simulation 패널이 보이는 Results 모드](docs/images/06_paths.png)
*Sionna 백엔드로 푼 레이 경로 5개 — 오른쪽 Simulation 패널에 Global / Beamforming / Paths 섹션이 있습니다.*
...
![Path gain 범례가 있는 라디오맵 히트맵](docs/images/07_radio_map.png)
*계산된 라디오맵이 jet 컬러맵 히트맵으로 씬 위에 깔리고, 범례에 dB 범위가 표시됩니다.*
